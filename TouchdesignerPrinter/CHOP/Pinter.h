...
*/
#define	EPS_PRINTER_NAME	"EPSON TM-T60 Receipt5"
#define EPS_DRIVER_NAME		"EPSON TM-T88V ReceiptE4"
#define	LOGO_FILENAME	"b.bmp"
...
class WorkshopCHOP : public CHOP_CPlusPlusBase
{
public:
	WorkshopCHOP(const OP_NodeInfo* info);
	virtual ~WorkshopCHOP();
